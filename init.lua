...
vim.keymap.set("n", "<leader>r", function() -- resize model 
	print("resize (hjkl, Esc to exit)")
	local function exit()
	...
	vim.keymap.set("n", "h", ":vertical resize -2<CR>", { buffer = 0 })
	vim.keymap.set("n", "j", ":resize +2<CR>", { buffer = 0 })
	vim.keymap.set("n", "k", ":resize -2<CR>", { buffer = 0 })
	vim.keymap.set("n", "l", ":vertical resize +2<CR>", { buffer = 0 })
	vim.keymap.set("n", "<Esc>", exit, { buffer = 0 })
...
vim.keymap.set("n", "<leader>fh", function()
	require("fzf-lua").files({ fd_opts = "--hidden --exclude .git" })
...
require("which-key").setup({
	...
	spec = {
		...
		{ "<leader>ft", desc = "typedefs" },
		{ "<leader>fs", desc = "document symbols" },
		{ "<leader>fw", desc = "workspace symbols" },
		{ "<leader>fi", desc = "implementations" },

		-- goto (lsp)
		{ "<leader>gd", desc = "definition (fzf)" },
		{ "<leader>gD", desc = "definition (jump)" },
		{ "<leader>gS", desc = "definition (vsplit)" },
		...
		-- lsp
		{ "<leader>lf", desc = "format (file/selection)" },

		-- diagnostics
		{ "<leader>dl", desc = "line diagnostics" },
...
-- rounded borders on hover/floats
do
...
local function lsp_on_attach(ev)
	...
	-- format: <leader>lf in normal mode (whole file) or visual mode (selection)
...
vim.opt.showtabline = 1 -- show tabline when multiple tabs open
